...
<div class="container-fluid">
    <h3 class="text-gray-800 mb-2">Manajemen Master Pallet</h3>

    <div class="card shadow mb-4">
        <div class="card-header py-3" style="display: flex; justify-content: space-between;">
            <h4 class="m-0 font-weight-bold text-primary">Data Pallet</h4>
                        ...
                        <?php foreach($rows as $row): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-hapus" data-id="<?= $row['id'] ?>" data-url="<?= base_url() ?>/pallet/hapus"><i class="fa fa-trash"></i> Hapus</button>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
...
<div class="modal fade in" id="modal-form1" role="dialog">
   <div class="modal-dialog" role="document">
        <form class="modal-content" id="form-input" create-action="<?= base_url() ?>/pallet" update-action='<?= base_url() ?>/pallet/update' method="post">
